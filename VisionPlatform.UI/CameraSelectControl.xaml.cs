    ...
    public partial class CameraSelectControl : UserControl
    {
        ...
        private void UpdateButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //SearchAllCamera();
                CameraListBoxItems.Add
                    (
                    new PUListBoxItemModel()
                    {
                        Header = "0.213",
                        Value = CameraListBoxItems.Count.ToString()
                    }
                    );
        ...
        public CameraSelectControl(ICamera camera)
        {
            ...
            CameraListBoxItems = new ObservableCollection<PUListBoxItemModel>();
        ...
        #region Bindings
        public ObservableCollection<PUListBoxItemModel> CameraListBoxItems
        {
            get { return _cameraListBoxItems; }
            set { _cameraListBoxItems = value; }
        }
        private ObservableCollection<PUListBoxItemModel> _cameraListBoxItems;
